...
static const FactoryPreset k_factory[] = {
    // 0: INIT — all table defaults + "Clean 106" routings (ADR 0009 RATIFIED)
    {
        ...
        {ParamId::OSC_LEVEL,    ParamId::SUB_LEVEL,    ParamId::NOISE_LEVEL,
         ParamId::OSC_PWM,      ParamId::OSC_WAVEFORM, ParamId::OSC_RANGE,
         ParamId::FILTER_CUTOFF, ParamId::FILTER_RES,  ParamId::FILTER_MODE,
         ParamId::HPF_CUTOFF,
         ParamId::VCF_ENV_DEPTH, ParamId::VCF_ENV_POLARITY, ParamId::VCF_KEY_TRACK, ParamId::VCF_LFO_DEPTH,
         ...
         ParamId::UNISON_COUNT, ParamId::UNISON_DETUNE},
        {0.70f, 0.30f, 0.05f,
         0.50f, 0.0f, 0.0f,
         2000.0f, 0.30f, 0.0f,
         20.0f,
         0.35f, 0.0f, 0.50f, 0.0f,
    ...
    // 1: Bass — thick sub, tight attack, dark filter + mono retrigger + subtle glide
    {
        ...
        {0.85f, 0.60f, 0.00f,
         ...
         800.0f, 0.50f, 0.0f,
         20.0f,
         0.50f, 0.0f, 0.30f, 0.0f,  /* stronger env mod for bass filter sweep */
    ...
    // 3: Lead — bright, cutting, legato mono + short glide + unison 2 + 10 cents
    {
        ...
        {0.90f, 0.10f, 0.00f,
         0.50f, 0.0f, 0.0f,
         6000.0f, 0.60f, 0.0f,
         80.0f,                      /* Lead: slight HPF to thin low end */
         0.30f, 0.0f, 0.70f, 0.0f,
